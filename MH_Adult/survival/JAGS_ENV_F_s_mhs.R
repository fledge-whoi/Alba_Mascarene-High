...
cov<-read_excel("ENV_cov.xlsx",sheet="F_survival")
...
out1 <- jags(jags.data, inits, parameters, "WA_ENV_F_s.txt", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE)

save(out1,file = "WA_ENV_F_s_mhs_1980_2018.RData")
