...
cov<-read_excel("ENV_cov.xlsx",sheet="M_survival")
COV<-scale(cov$mh_strength)
COV<-detrend(COV)
...
out1 <- jags(jags.data, inits, parameters, "WA_ENV_M_s.txt", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE)

save(out1,file = "WA_ENV_M_s_mhs_1980_2018.RData")
